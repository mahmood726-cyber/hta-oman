        # Hta Oman: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/hta-oman.git

        ## Objective

        HTA Oman adapts HTA methodologies for the Omani healthcare context, providing locally calibrated decision models and evidence synthesis frameworks.
        ...
        - Code: https://github.com/mahmood726-cyber/hta-oman.git
